...
namespace Unity.Tutorials.Core.Editor
{
    ...
    public class PrefabInstanceCountCriterion : Criterion
    {
        ...
        protected override bool EvaluateCompletion()
        {
            ...
            var matches = FindObjectsByType<GameObject>(FindObjectsSortMode.None).Where(go => PrefabUtilityShim.GetCorrespondingObjectFromSource(go) == PrefabParent);
        ...
        {
            var prefabInstances = FindObjectsByType<GameObject>(FindObjectsSortMode.None).Where(go => PrefabUtilityShim.GetCorrespondingObjectFromSource(go) == PrefabParent);
