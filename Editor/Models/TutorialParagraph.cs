...
namespace Unity.Tutorials.Core.Editor
{
    ...
    enum CompletionType
    {
        ...
        CompletedOnUserIndication,
        CompletedOnUserIndicationSkippable,
    }
    ...
    public class TutorialParagraph : ISerializationCallbackReceiver
    {
        ...
        public List<LocalizableString> m_PollItems;
        public int[] m_PollCorrectItemIndexes = { 0 };
        ...
        public bool disableImagePopup = false;
        ...
        [Serializable]
        public class CriterionErrorPair
        {
            [SerializeField] internal string errorTutorialText;
            [SerializeField] internal TypedCriterion Criterion = null;
        }
        [SerializeField] internal List<CriterionErrorPair> m_PossibleErrors;
        readonly List<TypedCriterion> m_PossibleErrorsBuffer = new List<TypedCriterion>();

        /// <summary>
        /// The completion criteria if this paragraph's type is Instruction.
        /// </summary>
        protected IEnumerable<CriterionErrorPair> PossibleErrors
        {
            get
            {
                return m_PossibleErrors;
            }
        }
        ...
        public bool UserIndicatedDone { get; set; }
        ...
        public bool Completed
        {
            get
            {
                if (m_Type == ParagraphType.Poll) // piggy-backing on this variable
                {
                    //Debug.Log("Poll: " + UserIndicatedDone);
                    return UserIndicatedDone;
                }
                else if (m_CriteriaCompletion == CompletionType.CompletedOnUserIndication)
                {
                    return UserIndicatedDone;
                }
                else if (m_CriteriaCompletion == CompletionType.CompletedOnUserIndicationSkippable)
                {
                    return UserIndicatedDone || UserIndicatedSkipped;
                }
        ...
        public string ErrorTutorialText
        {
            get
            {
                foreach (var typedCriterion in m_Criteria)
